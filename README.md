# Serious Game Quiz
![PlayWorld Logo](/Assets/IMG/Logos/PlayWorld_Logo.png)
**Impara giocando, divertiti apprendendo**\
Il Serious Game Quiz nasce dall’idea di unire divertimento e conoscenza in un’esperienza interattiva e dinamica. Realizzato con Unity, C#, MySQL, Express e Node.js, questo progetto propone un nuovo approccio all’apprendimento: vivere il sapere in modo attivo, diretto e coinvolgente.

Durante il quiz, l’utente sceglie una categoria e risponde a una serie di domande pensate per verificare e ampliare le sue conoscenze. In caso di errore, viene trasportato in una scena esplicativa che illustra chiaramente l’argomento, trasformando l’errore in un punto di partenza per comprendere e migliorare.

**Fluidità e velocità: due elementi chiave**\
L’esperienza di gioco è stata progettata per essere fluida, reattiva e veloce, affinché l’utente resti immerso senza interruzioni o caricamenti superflui. Ogni transizione, animazione e scena è ottimizzata per mantenere un flusso continuo tra gioco e apprendimento, assicurando un’esperienza piacevole, intuitiva e accessibile a tutti.

**Un’esperienza guidata e familiare**\
Ad accompagnare l’utente c’è una figura speciale: Gerry Scotti in versione cartoon, simbolo del quiz televisivo italiano. La sua presenza aggiunge un tono familiare, ironico e motivante, creando un ambiente accogliente e positivo.
...
**“L’apprendimento è più efficace quando diventa un’esperienza, non solo un dovere.”**